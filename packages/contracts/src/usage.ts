 ...
 * `~/.grok/sessions/**\/updates.jsonl`, `~/.hermes/state.db`) rather than relying on T3 Code's own
 ...
 *
 * v5 added `grok` and v6 adds `hermes` to {@link UsageProviderKind}; v4
...
export const UsageProviderKind = Schema.Literals(["claude", "codex", "grok", "hermes"]);
